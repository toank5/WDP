/**
 * Policy-related type definitions shared between frontend and backend
 */

import { POLICY_TYPES } from '../enums/policy.enums';

/**
 * Policy Type as a union
 */
...
/**
 * Legal Policy Config (empty but validated)
 */
